...
func (in *BackupEncryptionConfig) DeepCopyInto(out *BackupEncryptionConfig) {
	*out = *in
	if in.LibsodiumConfig != nil {
		in, out := &in.LibsodiumConfig, &out.LibsodiumConfig
...
func (in *BackupEncryptionConfigWithSecrets) DeepCopyInto(out *BackupEncryptionConfigWithSecrets) {
	*out = *in
	...
	if in.LibsodiumConfig != nil {
		in, out := &in.LibsodiumConfig, &out.LibsodiumConfig
		*out = new(BackupEncryptionLibsodiumConfigWithSecrets)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BackupEncryptionLibsodiumConfigWithSecrets) DeepCopyInto(out *BackupEncryptionLibsodiumConfigWithSecrets) {
	*out = *in
	in.BackupEncryptionLibsodiumConfig.DeepCopyInto(&out.BackupEncryptionLibsodiumConfig)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BackupEncryptionLibsodiumConfigWithSecrets.
func (in *BackupEncryptionLibsodiumConfigWithSecrets) DeepCopy() *BackupEncryptionLibsodiumConfigWithSecrets {
	if in == nil {
		return nil
	}
	out := new(BackupEncryptionLibsodiumConfigWithSecrets)
